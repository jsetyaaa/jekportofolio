...
const HeroSection = () => {
  return (
    <div className="flex flex-col items-center justify-evenly px-6 py-8 md:px-12 sm:flex-row-reverse md:gap-8 h-screen pt-24">
      ...
      <div className=" flex flex-col items-start md:px-6">
        ...
        <h1 className="text-2xl font-semibold mt-2 text-center md:text-3xl lg:text-5xl text-second font-cabin">
          <Typewriter
            options={{
              strings: ["I'm Web Developer", "I'm Data Analyst"],
              autoStart: true,
              loop: true,
              delay: 75,
              deleteSpeed: 50,
